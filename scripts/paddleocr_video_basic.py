        ...
        while cap.isOpened():
            ...
            for result in results:
                for box in result.boxes:
                    ...
                    print(plate_text)
                    # Log the recognized plate text to a file
                    with open("plate_log.txt", "a") as log_file:
                        log_file.write(f"{plate_text}\n")
                    # Draw results
...
lpr.process_video("videos/alprVideo.mp4", "output.mp4", show_live=False)